...
//        if (Input.GetAxis("Mouse X") * sensitivityX * Time.timeScale != 0)
//        {
//            Debug.Log(Time.frameCount);
//            Debug.Log("Movement of " + Input.GetAxis("Mouse X") * sensitivityX * Time.timeScale + " on X"); 
//        }
        ...
        {  
            ...
            // Ignore the first move on the X axis because it will be from the mouse lock
            if (Input.GetAxis("Mouse X") * sensitivityX * Time.timeScale != 0 && checkedX != 0)
            {
                checkedX--;
//                Debug.Log("Ignoring X.");
                return;
            }
        ...
        {        
            ...
            // Ignore the first move on the Y axis because it will be from the mouse lock
            
            if (Input.GetAxis("Mouse Y") * sensitivityY * Time.timeScale != 0 && checkedY != 0)
            {
                checkedY--;
//                Debug.Log("Ignoring Y.");
                return;
            }
